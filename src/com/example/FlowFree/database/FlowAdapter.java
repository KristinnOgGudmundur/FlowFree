...
public long insertFlows( int fid, int Size, String flow1, String flow2, String flow3, String flow4, String flow5, String flow6) {
        ...
        contentValues.put( cols[3], flow1);
        contentValues.put( cols[4], flow2);
        contentValues.put( cols[5], flow3);
        contentValues.put( cols[6], flow4);
        contentValues.put( cols[7], flow5);
        contentValues.put( cols[8], flow6);
        openToWrite();
...
public long updateFlows( int fid, int Size, String flow1, String flow2, String flow3, String flow4, String flow5, String flow6) {
    String[] cols = DBHelper.TableFlowsCols;
    ContentValues contentValues = new ContentValues();
    contentValues.put(cols[1], ((Integer) fid).toString());
    contentValues.put(cols[2], ((Integer) Size).toString());
